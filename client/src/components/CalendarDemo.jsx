...
const generateDemoSlots = () => {
  ...
  for (let day = 1; day <= 7; day++) {
    ...
    startTimes.forEach(hour => {
      if (Math.random() > 0.3) { // Randomly skip some slots to show realistic availability
    ...
    <div className="space-y-6">
      ...
      <Card className="shadow-lg border-blue-200">
        <CardHeader>
          ...
          <CardDescription>
            This is a demonstration of the Google Calendar integration. In production, this would connect to real Google Calendar accounts.
          </CardDescription>
        </CardHeader>
      </Card>
          ...
          <div className="space-y-4">
            <div>
              ...
              <Select onValueChange={(value) => {
                ...
                <SelectContent>
                  {decisionMakers.length > 0 ? decisionMakers.map((dm) => (
            ...
            {selectedDecisionMaker && (
              <div className="p-4 bg-blue-50 rounded-lg">
                ...
                <Badge className="mt-2 bg-blue-200 text-blue-800">Demo User</Badge>
              </div>
            )}
          </div>
        </CardContent>
      ...
      {selectedDecisionMaker && (
        <Card className="shadow-lg">
          <CardHeader>
            ...
            <CardDescription>
              These are simulated available time slots. In production, these would come from real Google Calendar data.
            </CardDescription>
          </CardHeader>
          <CardContent>
            {demoAvailability.length > 0 ? (
              <div className="space-y-4">
                {Object.entries(groupSlotsByDay(demoAvailability)).map(([date, slots]) => (
                  ...
                  <Dialog open={isBookingOpen} onOpenChange={setIsBookingOpen}>
                    ...
                    <DialogContent>
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          This will simulate scheduling a meeting. In production, this would create a real calendar event.
                        </DialogDescription>
                      </DialogHeader>
                      <div className="space-y-4">
                        <div className="p-4 bg-gray-50 rounded-lg">
                          ...
                          <Badge className="mt-1 bg-yellow-100 text-yellow-800">Demo Mode</Badge>
                        </div>
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-500">
                  Demo availability will appear here when you select a decision maker
                </p>
              </div>
            )}
          </CardContent>
      ...
      <Card className="shadow-lg border-yellow-200 bg-yellow-50">
        <CardContent className="pt-6">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h4 className="font-medium text-yellow-800 mb-1">Demo Mode Active</h4>
              <p className="text-sm text-yellow-700">
                This is a demonstration of the Google Calendar integration. In production, users would connect their real Google Calendar accounts to view actual availability and schedule real meetings.
              </p>
            </div>
          </div>
        </CardContent>
