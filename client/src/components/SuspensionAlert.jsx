      ...
      <AlertDescription className="text-red-800">
        <div className="space-y-2">
          ...
          <div className="text-xs text-red-600 mt-2">
            While suspended, you cannot book meetings or invite new decision makers. 
            Your suspension will be lifted when a decision maker completes a call successfully without negative feedback.
          </div>
        </div>
      </AlertDescription>
    </Alert>
