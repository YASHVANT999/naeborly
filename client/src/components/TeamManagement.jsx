...
export default function TeamManagement() {
  ...
  const getStatusBadge = (status) => {
    switch (status) {
      ...
      case 'invited':
        return <Badge variant="outline" className="bg-yellow-100 text-yellow-800">Invited</Badge>;
      default:
              ...
              <DialogContent className="sm:max-w-md">
                <form onSubmit={handleInviteSubmit}>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Add a new sales rep to your team. They must use a techize.com email address.
                    </DialogDescription>
                  </DialogHeader>
              ...
              {loadingDMs ? (
                ...
                <div className="space-y-3">
                  {decisionMakers.map((dm) => {
                    ...
                    const hasPermission = member?.permissions?.includes(dm.id) || false;
                      ...
                      <div key={dm.id} className="flex items-center space-x-3">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => {
                            ...
                            handlePermissionsUpdate(selectedUserId, newPermissions);
                          }}
                        />
                        <Label htmlFor={`dm-${dm.id}`} className="flex-1">
                          <div>
                            ...
                            <div className="text-xs text-gray-400">{dm.jobTitle}</div>
                          </div>
                        </Label>
                      </div>
                    );
