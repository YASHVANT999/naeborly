                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <p className="mt-1 text-gray-900 font-medium">{profile?.firstName || 'Not provided'}</p>
                    )}
                  </div>
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <p className="mt-1 text-gray-900 font-medium">{profile?.lastName || 'Not provided'}</p>
                    )}
                  </div>
                </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center mt-1">
                      ...
                      {isEditing ? (
                        ...
                        <p className="text-gray-900 font-medium">{profile?.company || 'Not provided'}</p>
                      )}
                    </div>
                  </div>
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <p className="mt-1 text-gray-900 font-medium">{profile?.jobTitle || 'Not provided'}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <p className="mt-1 text-gray-900 font-medium capitalize">{profile?.industry || 'Not provided'}</p>
                    )}
                  </div>
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <p className="mt-1 text-gray-900 font-medium">{profile?.companySize || 'Not provided'}</p>
                    )}
                  </div>
                </div>
                ...
                <div>
                  ...
                  {isEditing ? (
                    <Select value={formData.yearsInRole} onValueChange={(value) => handleInputChange('yearsInRole', value)}>
                      <SelectTrigger>
                    ...
                    <p className="mt-1 text-gray-900 font-medium">{profile?.yearsInRole || 'Not provided'}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="mt-1 text-gray-700">{profile?.specialties || 'No specialties listed'}</p>
                  )}
                </div>
              </CardContent>
            </Card>
                ...
                <div>
                  ...
                  <div className="flex items-center mt-1">
                    ...
                    {isEditing ? (
                      ...
                      <p className="text-gray-900 font-medium">{profile?.linkedinUrl || 'Not provided'}</p>
                    )}
                  </div>
                </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center">
                      <p className="text-2xl font-bold text-blue-600">{stats.totalCalls || 0}</p>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium">{stats.dmsInvited || 0}</span>
                    </div>
                    <div className="flex justify-between text-sm">
