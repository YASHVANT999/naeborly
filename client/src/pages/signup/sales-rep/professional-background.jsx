...
export default function SalesRepProfessionalBackground() {
  ...
  const handleBack = () => {
    setLocation("/signup/sales-rep/personal");
  };

  const canProceed = formData.jobTitle && formData.company && formData.industry && 
                   formData.companySize && formData.yearsInRole;
        ...
        <Card className="shadow-lg">
          <CardContent className="p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Tell us about your role and company</p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                <Label htmlFor="yearsInRole" className="text-sm font-medium text-gray-700">
                  Years in Current Role
                </Label>
                <Input
                  id="yearsInRole"
