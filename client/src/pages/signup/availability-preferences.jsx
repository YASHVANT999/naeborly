        ...
        <Card className="shadow-lg">
          <CardContent className="p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Set your calling preferences and availability</p>
            </div>
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <Label htmlFor="weeklyCallSlots" className="text-sm font-medium text-gray-700">
                    Weekly Call Slots *
                  </Label>
                  <Select onValueChange={(value) => handleInputChange("weeklyCallSlots", value)}>
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <span className={`font-medium ${
                          formData.callTypes.includes(type) ? "text-purple-700" : "text-gray-900"
                        }`}>
                          {type}
                        </span>
                        {formData.callTypes.includes(type) && (
