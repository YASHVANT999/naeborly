...
const GOOGLE_REDIRECT_URI = process.env.GOOGLE_REDIRECT_URI || `https://44892040-2026-48f1-a224-0c22212f220b-00-1iyarcm83n4u6.janeway.replit.dev/api/auth/google/callback`;
